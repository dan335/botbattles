...
import TaserBullet from '../game/abilityObjects/TaserBullet.js';
...
const messageFunctions =  {
  ...
  taserBulletInitial: function(json, manager) {
    manager.abilityObjects.push(new TaserBullet(manager, Number(json.x), Number(json.y), Number(json.rotation), Number(json.radius), json.id, json.color));
  },

  taserBulletUpdate: function(json, manager) {
    const projectile = manager.abilityObjects.find((o) => {
      return o.id == json.id;
    })
  ...
  taserBulletDestroy: function(json, manager) {
    const projectile = manager.abilityObjects.find((o) => {
      return o.id == json.id;
    })

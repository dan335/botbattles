module.exports = {
  ...
  abilityTypes: [
    ...
    },
    {
      name: 'Force Field',
      id: 'ForceField',
      description: 'Creates a shield that stop projectiles around player for a short time.  2 sec duration.  5 sec cooldown.',
      categories: ['defense']
    },
    {
      name: 'Grenade Launcher',
      id: 'GrenadeLauncher',
      description: 'Launch a grenade that is detonated next time you fire the ability.  Grenades explode immediatly if they contact a player or wall.  Does up to 100 damage based on how close the explosion is. 5 sec cooldown.',
      categories: ['projectiles']
    },
    {
      name: 'Smasher',
      id: 'Smasher',
      description: 'Turn into a weapon.  Damage someone when you smash into them. 5 sec cooldown.',
      categories: ['melee']
    },
    {
      name: 'Dash',
      id: 'Dash',
      description: 'Dash forward.  2 sec cooldown.',
      categories: ['mobility']
    },
    {
      name: 'Cannon',
      id: 'Cannon',
      description: 'Charge for 1 sec then fire three big blaster bullets.  3.5 sec cooldown.',
      categories: ['projectiles']
    },
    {
      name: 'Slam',
      id: 'Slam',
      description: 'Stun nearby players.  100 radius.  1.25 sec stun duration.  5 sec cooldown.',
      categories: ['aoe']
    },
    {
      name: 'Mine Dropper',
    ...
    },
    {
      name: 'EMP',
      id: 'Emp',
      description: 'Disable shields of nearby players.  250 radius.  9 sec cooldown',
      categories: ['aoe']
    },
    {
      name: 'Bullet Time',
    ...
    },
    {
      name: 'Stun Gun',
      id: 'StunGun',
      description: 'Stun enemies from a distance.  1.5 sec stun duration.  2 sec cooldown.',
    ...
    },
    {
      name: 'Vacuum',
      id: 'Vacuum',
      description: 'Suck objects towards you. 250 radius.  1 sec duration.  5 sec cooldown.',
      categories: ['control', 'aoe']
    },
    {
      name: 'Silencer',
      id: 'Silencer',
      description: 'Prevent players from using their abilities.  250 radius.  2500 silence duration.  5 sec cooldown.',
      categories: ['control', 'aoe']
    },
    {
      name: 'Freeze',
    ...
    },
    {
      name: 'Slicer',
      id: 'Slicer',
      description: 'Damage players when you are touching them.  1.5 sec duration.',
      categories: ['melee']
    },
    {
      name: 'Freeze Trap',
      id: 'FreezeTrap',
      description: 'Drop a mine.  Freezes players who trigger it.  15 traps max.  1.5 sec freeze duration.    250 radius.',
      categories: ['control']
    },
    {
    ...
    },
    {
      name: 'Turret',
      id: 'Turret',
      description: 'Create a turret that fires at closest enemy.  12 sec cooldown.  Bullets do 5 damage.',
      categories: ['control', 'passive', 'defense']
    },
    {
      name: 'Mouse Seeker',
      id: 'MouseSeeker',
      description: 'Bullet follows mouse currsor.  50 damage.  1 sec cooldown.',
      categories: ['projectiles']
    },
    {
      name: 'Charger',
    ...
    },
    {
      name: 'Rage',
      id: 'Rage',
      description: 'All ability cooldowns are halved while raging.  When rage is over player is stunned for 1.5 sec.  12 sec cooldown.',
      categories: ['passive']
    },
    {
      name: 'Heal',
      id: 'Heal',
      description: 'Heal ability stuns you for 3 sec then heals you for 150 health.  10 sec cooldown.',
      categories: ['control']
    }
  ]
}

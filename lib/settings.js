module.exports = {
  ...
  abilityTypes: [
    ...
    },
    {
      name: 'Force Field',
      id: 'ForceField',
      description: 'Creates a shield that causes bullets to ricochet off and can damage shooter.  2 sec duration.  5 sec cooldown.',
      categories: ['defense']
    },
    {
    ...
    },
    {
      name: 'Smasher',
      id: 'Smasher',
      description: 'Turn into a weapon.  Damage someone when you smash into them. 3.5 sec cooldown.',
      categories: ['melee']
    },
    {
      name: 'Dash',
    ...
    },
    {
      name: 'Slicer',
      id: 'Slicer',
      description: 'Damage players when you are touching them.  3.5 sec cooldown. 2 sec duration.',
      categories: ['melee']
    },
    {
      name: 'Freeze Trap',

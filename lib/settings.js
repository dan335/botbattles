module.exports = {
  ...
  abilityTypes: [
    ...
    },
    {
      ...
      id: 'GrenadeLauncher',
      description: 'Launch a grenade that is detonated next time you fire the ability.  Grenades explode immediately if they contact a player or wall.  Does up to 100 damage based on how close the explosion is. 5 sec cooldown.',
      categories: ['projectiles']
    },
    {
      name: 'Smasher',

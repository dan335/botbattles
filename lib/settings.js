  ...
  abilityTypes: [
    {
      name: 'Blasters',
      id: 'Blasters',
      description: 'Rapid fire blaster weapon. 12 damage. 250ms cooldown.',
    ...
    },
    {
      name: 'Player Seeker',
      id: 'PlayerSeeker',
      description: 'Fires missles that seeks players.  25 damage.  1 sec cooldown.',
      categories: ['projectiles']
    },
    {
      name: 'Vacuum',
    ...
    },
    {
      name: 'Silencer',
      id: 'Silencer',
      description: 'Prevent players from using their abilities.  250 radius.  3 sec silence duration.  4 sec cooldown.',
      categories: ['control', 'aoe']
    },
    {
      name: 'Freeze',
    ...
    },
    {
      name: 'Turret',
      id: 'Turret',
      description: 'Create a turret that fires at closest enemy.  12 sec cooldown.  Bullets do 8 damage.  90 Health.',

module.exports = {
  ...
  abilityTypes: [
    ...
    },
    {
      name: 'EMP',
      id: 'Emp',
      description: 'Disable shields of nearby players.  250 radius.  8 sec cooldown',
      categories: ['aoe']
    },
    // {
    //   name: 'Bullet Time',
    ...
    },
    {
      name: 'Turret',
      id: 'Turret',
      description: 'Create a turret that fires at closest enemy.  12 sec cooldown.  Bullets do 8 damage.  150 Health.',

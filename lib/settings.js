module.exports = {
  ...
  abilityTypes: [
    ...
    },
    {
      name: 'EMP',
      id: 'Emp',
      description: 'Disable shields of nearby players.  250 radius.  11 sec cooldown',
      categories: ['aoe']
    },
    // {
    //   name: 'Bullet Time',
    ...
    // },
    {
      name: 'Stun Gun',
      id: 'StunGun',
      description: 'Stun enemies from a distance.  1.5 sec stun duration.  2.5 sec cooldown.',
    ...
    },
    {
      name: 'Vacuum',
      id: 'Vacuum',
      description: 'Suck objects towards you. 300 radius.  1 sec duration.  5 sec cooldown.',
    ...
    },
    {
      name: 'Revive',
      id: 'Resurrection',
      description: 'Go back to max health when you die.  100 sec cooldown',
      categories: ['passive']
    },
    {
      name: 'Slicer',
      id: 'Slicer',
      description: 'Damage players when you are touching them.  2 sec duration.',
      categories: ['melee']
    },
    {
      name: 'Freeze Trap',
    ...
    },
    {
      name: 'Turret',
      id: 'Turret',
      description: 'Create a turret that fires at closest enemy.  12 sec cooldown.  Bullets do 6 damage.  150 Health.',
    ...
    },
    {
      name: 'Rage',
      id: 'Rage',
      description: 'All ability cooldowns are halved while raging.  When rage is over player is stunned for 0.5 sec.  12 sec cooldown.',
      categories: ['passive']
    },
    {
      name: 'Heal',
      id: 'Heal',
      description: 'Heal ability stuns you for 3 sec then heals you for 100 health.  10 sec cooldown.',
      categories: ['control']
    }
  ]
}
